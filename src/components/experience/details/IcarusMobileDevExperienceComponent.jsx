    ...
    return (
        <Box sx={{ maxWidth: '800px', textAlign: 'justify' }}>
            <ul>
                ...
                <li>Demonstrated strong skills during project that led to quick transition into leading the Web Development Team & enhancing internal tools.</li>
            </ul>
...
export default IcarusMobileDevExperienceComponent;
